...
IPC_STRUCT_BEGIN(FrameMsg_ExtendedLoadingProgress_Params)
  ...
  IPC_STRUCT_MEMBER(double, load_progress)

  // Total number of bytes loaded on this page
  IPC_STRUCT_MEMBER(double, loaded_bytes)

  // Total number of elements loaded on this page
  IPC_STRUCT_MEMBER(int, loaded_elements)

  // Total number of external elements found on this page
  IPC_STRUCT_MEMBER(int, total_elements)
IPC_STRUCT_END()
...
// Sent when the renderer changed the progress of a load.
IPC_MESSAGE_ROUTED1(FrameHostMsg_DidChangeLoadProgressExtended,
                    FrameMsg_ExtendedLoadingProgress_Params)
